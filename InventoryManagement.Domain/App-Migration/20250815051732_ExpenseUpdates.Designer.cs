...
namespace InventoryManagement.Domain.AppMigration
{
    ...
    [Migration("20250815051732_ExpenseUpdates")]
    partial class ExpenseUpdates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoryManagement.Domain.Model.Supplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("InventoryManagement.Domain.Model.Expense", b =>
                {
                    b.HasOne("InventoryManagement.Domain.Model.Supplier", "Supplier")
                        .WithMany()
